 ...
 useEffect(() => {
  ...
  <div
    className={`transition-all duration-300 ${
      isSticky
        ? "fixed top-16 left-0 right-0 bg-white dark:bg-gray-900 z-20 py-3"
        : ""
    }`}
  >
    <div
    ...
    >
      <div className="hidden md:flex items-center gap-3">
        {!isSticky ? (
          ...
          <h1 className="text-4xl font-bold mb-2 text-gray-800 dark:text-neutral-200">
            {model.name}
          </h1>
        )}
      </div>
      ...
      <div className="flex items-center gap-3 text-sm">
        <div className="flex gap-3">
          <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-md flex items-center gap-1 dark:text-neutral-200">
            <FaCloudDownloadAlt /> {purchased}
          </span>
          <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-md flex items-center gap-1 dark:text-neutral-200">
            <FaEye /> {model.views || 0}
          </span>
          <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-md flex items-center gap-1">
        ...
        {isCreator && (
          <>
            ...
            <button
              ...
              className="btn btn-sm bg-red-600 hover:bg-red-700 text-white btn-error"
            >
              Delete
            </button>
          </>
  ...
  >
    ...
    <div>
      <img
        ...
        alt={model.name}
        className="w-[200px] rounded-lg object-cover mx-auto border dark:border-gray-600"
      />
    </div>
  </div>
  ...
  <div className="grid md:grid-cols-[80%_auto] gap-10 mt-8">
    <div>
      <h3 className="text-2xl font-semibold mb-3 text-gray-800 dark:text-neutral-200">
        Description
      </h3>
      <p className="text-gray-700 dark:text-neutral-300 leading-relaxed text-justify">
        {model.description || "No description provided."}
      </p>
    </div>

    <div className="space-y-3 p-5 text-gray-800 dark:text-neutral-200">
      <p>
  ...
  <dialog ref={deleteModal} className="modal dark:bg-gray-800 dark:text-neutral-200">
