    ...
    <div className="w-full lg:w-1/2 xl:w-2/5 px-4 mb-16 lg:mb-0">
      ...
      <div className="flex mb-6 justify-center items-center -mx-2">
        <button
          ...
          className="btn w-full bg-white dark:bg-gray-700 py-3 px-4 text-black dark:text-white border-gray-400 dark:border-gray-600 hover:border-gray-800 rounded-full border transition duration-100"
        >
          <svg
      ...
      <div className="flex mb-6 items-center">
        ...
        <span className="mx-4 text-sm font-semibold text-gray-500 dark:text-neutral-400">Or</span>
        <div className="w-full h-px bg-gray-300 dark:bg-gray-600"></div>
      </div>
      ...
      <form onSubmit={handleRegister}>
        ...
        <div className="flex mb-6 items-center">
          ...
          <label className="ml-2 text-xs text-gray-800 dark:text-neutral-200" htmlFor="remember">
        ...
        >
          ...
          <span className="relative z-10">{disabled ? "Loading..." : "Register"}</span>
        </button>
