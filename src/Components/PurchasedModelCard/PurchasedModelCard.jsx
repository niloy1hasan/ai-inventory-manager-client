      ...
      <div className="card-body flex flex-col justify-between lg:w-2/3">
        <div>
          <div className="flex items-start justify-between">
            <h2 className="card-title text-2xl font-bold text-gray-800">{modelName}</h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-1 pr-3 text-sm mt-3">
          ...
          <p>
            <span className="font-semibold text-gray-700">Use Case:</span> {useCase}
          </p>
          <p>
            <span className="font-semibold text-gray-700">Dataset:</span> {dataset}
          </p>
          <p>
